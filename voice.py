...
#select,cut,copy,pest,undu,redu.-----------------------------------------------------------------------------
        elif "select this line" in query:
            time.sleep(3)
            pyautogui.tripleClick()
        elif "select this " in query:
            time.sleep(3)
            pyautogui.click()
        ...
        elif "copy this file" or "copy this folder" or "copy this line" or "copy this" in query:
            time.sleep(3)
            pyautogui.hotkey('ctrl', 'c')
            speak("Sir copy done.")

        elif "pest this file" or "pest this folder" or "pest this line" or "pest this" in query:
            time.sleep(3)
