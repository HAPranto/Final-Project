...
def wishMe():
    ...
    speak("I am Captain Sir. Please tell me or write how may I help you. ")
...
def news():
    main_url = "https://newsapi.org/v2/everything?q=tesla&from=2021-10-24&sortBy=publishedAt&apiKey=a19ebc893eba4f44b2efe12a8a858444"
...
def SelectFile():
    time.sleep(3)
    pyautogui.click()
    speak("ok sir the file was selected")

def onlyText(inputText):
    #wishMe()
    while True:
        #userInput = commandBox.get("1.0","end-1c")
        #print(userInput)
...
#select,cut,copy,pest,undu,redu.----------------------------------------------
        ...
        elif "select this file" or "select this folder" in userInput:
            SelectFile()
        elif "select all file" or "select all folder" in userInput:
            time.sleep(3)
            pyautogui.hotkey('ctrl', 'a')
            speak("ok sir all file was selected")

        elif "copy this file" or "copy this folder" or "copy this line" in userInput:
            time.sleep(3)
            pyautogui.hotkey('ctrl', 'c')
            speak("Sir copy done.")

        elif "pest this file" or "pest this folder" or "pest this line" in userInput:
            time.sleep(3)
